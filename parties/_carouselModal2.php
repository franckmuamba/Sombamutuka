...
function make_slide_indicators2($bd)
{
    global $idi;
    //echo $idi;
    //die();
   // echo $_GET['id'];
    ...
    foreach($result2 as $res)
    {
        ...
        {
            $output .= '
            <button type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="'.$count2.'" class="active" aria-current="true" aria-label="Slide '.$count2.'" ></button>
            ';
        }
        else
        {
            $output .= '
            <button type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide-to="'.$count2.'" aria-label="Slide '.$count2.'"></button>
            ';
        }
        $count2 = $count2 + 1;
    }
