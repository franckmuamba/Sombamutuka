...
<table id="example" class="display" style="width:100%">
        ...
        <?php
              ...
              M.valide, M.id, M.marque, M.modele, M.couleur, M.km, M.transmission, M.prix, M.localisation, M.categorie, U.adresse, M.like_count, M.created_at, M.imagePost
           ...
           // die();
            ...
            <tr id="ligne"  style="cursor:pointer" onclick="">
                ...
                <td>
                <button type="button" name="view" class="btn btn-primary view" id="<?= $post->id ?>">
                  Valider
