                              ...
                              <div class="bd-example">
                                        ...
                                        <nav>
                                                <div class="nav nav-tabs mb-3" id="nav-tab" role="tablist">
                                                        <button onclick="window.location. href='filtrepost.php';" class="nav-link " id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="false">Véhicule</button>
                                                        <button onclick="window.location. href='motos.php';" class="nav-link active" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="true">Motos</button>
